...
class HubertConfig(FairseqDataclass):
    ...
    label_rate_list: List[float] = II("task.label_rate_list")
    use_multiple_frame_rate_label: Optional[bool] = II("task.use_multiple_frame_rate_label")
...
class HubertModel(BaseFairseqModel):
    ...
    def forward_targets(
        ...
        # 修改了部分代码，在有多个不同帧率的标签的时候，不对特征进行裁剪
